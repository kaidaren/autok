...
/**
 * Visible foreground activity used to request media projection permission.
 * Some ROMs block transparent/background request activities.
 */
class ScreenCapturePermissionActivity : AppCompatActivity() {
    ...
    companion object {
        ...
        private val requestIdGen = AtomicLong(1000L)
